...
const Explore = () => {
    ...
    return (
        <div className='flex-1 bg-[#161616] w-[75%] mx-2.5 rounded-2xl px-6 py-5 overflow-y-auto custom-scrollbar'>
            ...
            <div className='mt-3' AlbumList>
                <h3 className='font-bold text-xl'>Featured Charts</h3>
                <div className="flex overflow-x-auto justify-between custom-scrollbar-explore  " onWheel={handleWheel}>
            ...
            <div className='mt-3' SongList>
                <h3 className='font-bold text-xl'>Made For you</h3>
                <div className="flex overflow-x-auto justify-between  custom-scrollbar-explore " ref={cardsRef}>
                    {songsData.map((album) => (
